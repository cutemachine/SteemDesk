...
const ACCOUNT_HISTORY_STATUS_SET = 'steem/ACCOUNT_HISTORY_STATUS_SET'
const ACCOUNT_HISTORY_LOAD_MORE = 'steem/ACCOUNT_HISTORY_LOAD_MORE'
...
export default {
  ACCOUNT_HISTORY_SET,
  ACCOUNT_HISTORY_STATUS_SET,
  ACCOUNT_HISTORY_LOAD_MORE,
  DELEGATIONS_SET,
